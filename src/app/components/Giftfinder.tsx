...
const DEFAULT_CARDS: GiftCard[] = [
  {
    ...
    cta: { label: "Jetzt stöbern", href: "/pages/products?collection=mannerwelt-bier" },
  },
  {
    id: "frauen",
    icon: <IconSparkles />,
    ...
    cta: { label: "Schmuck ansehen", href: "/pages/products?collection=gravur-und-personalisierung" },
  },
  {
    id: "zuhause",
    icon: <IconHome />,
    ...
    cta: { label: "Deko entdecken", href: "/pages/products?collection=wohnen-und-deko" },
  },
  {
    id: "tiere",
    icon: <IconPaw />,
    ...
    cta: { label: "Jetzt ansehen", href: "/pages/products?collection=untersetzer-tischdeko" },
  },
  {
    id: "anlaesse",
    icon: <IconCalendar />,
    ...
    cta: {
      ...
      href: "/pages/products?collection=geschenke-und-anlaesse",
    },
  },
  {
    id: "wunsch",
